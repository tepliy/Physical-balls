		...
		var anchor:Vec2;
			...
			body.cbType = cbtype("null");
				...
				cbType = cbtype("null");
						...
						s = new Polygon(
							[   Vec2.weak(702,0)   ,  Vec2.weak(702,1114)   ,  Vec2.weak(752,1280)   ,  Vec2.weak(752,0)   ],
							mat,
							filt
						);
						s.body = body;
						...
						s = new Polygon(
							[   Vec2.weak(752,1280)   ,  Vec2.weak(702,1114)   ,  Vec2.weak(48,1114)   ,  Vec2.weak(0,1280)   ],
							mat,
							filt
						);
						s.body = body;
						...
						s = new Polygon(
							[   Vec2.weak(0,1280)   ,  Vec2.weak(48,1114)   ,  Vec2.weak(40,0)   ,  Vec2.weak(0,0)   ],
							mat,
							filt
						);
						s.body = body;
			...
			anchor = (true) ? body.localCOM.copy() : Vec2.get(-425.99999872,274);
			body.translateShapes(Vec2.weak(-anchor.x,-anchor.y));
			body.position.setxy(0,0);

			bodies["background"] = new BodyPair(body,anchor);
